...
int main(void)
{
    /* Configure the SWD/JTAG pins, including the TDO pin used for SWO. */
    board_pins_config();

    /* The test firmware needs no peripherals and keeps cacheable RAM coherent with the debugger. */
    return app_main();
}
