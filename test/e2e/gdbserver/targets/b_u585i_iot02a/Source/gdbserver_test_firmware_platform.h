/*
 * B-U585I-IOT02A implementation of services required by the generic gdbserver
 * test firmware. This is the only board-specific interface consumed by the
 * shared firmware core in ../../gdbserver_test_firmware.c.
 */
